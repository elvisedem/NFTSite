 ...
 * @author BLAZE
 */
public class NextArtPageServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(pageNumberParam != null)
            {
                ...
                List<NftArt> moreProjects = NftDAO.viewMoreNftArts(offset);
...
// Calculate the total number of pages based on the total number of items and the number of items per page
                ...
                request.setAttribute("studentProjects", moreProjects);
