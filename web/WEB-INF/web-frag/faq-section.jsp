<%--
    ...
    Created on : 27-Jun-2023, 13:04:25
    Author     : HULLO
--%>
...
<section id="features" class="a1E[90px]">
    <div class="ae">
        <div class="a1J a1K aL[650px] a1L">
            ...
            <p class="a1Q a1o a1t">
                Here's a list of some of the benefits of partnering with us
            </p>
        </div>
        <div class="a1R a3 a1S">
            ...
            <div class="a4 ak md:a1T/2 lg:a1T/3 2xl:a1T/4">
                <div class="aU a1U a1V a1W a1G aM a1X a1w hover:a1z hover:aH">
                    ...
                    <p class="aW a1o a1t">
                        We provide artists and creators with a platform to unleash their imagination, turn their vision into NFTs, and share their unique expressions with the world.
                    </p>
                </div>
            </div>
            ...
            <div class="a4 ak md:a1T/2 lg:a1T/3 2xl:a1T/4">
                <div class="aU a1U a1V a1W a1G aM a1X a1w hover:a1z hover:aH">
                    ...
                    <p class="aW a1o a1t">
                        Our intuitive interface makes it easy for artists of all levels to mint their digital creations as NFTs. With a few simple steps, you can upload your artwork, customize metadata, and set the desired parameters to create a truly unique digital asset.
                    </p>
                </div>
            </div>
            ...
            <div class="a4 ak md:a1T/2 lg:a1T/3 2xl:a1T/4">
                <div class="aU a1U a1V a1W a1G aM a1X a1w hover:a1z hover:aH">
                    ...
                    <p class="aW a1o a1t">
                        Sell your NFTs on Our Market or build your own NFT marketplace with our robust APIs. Create a seamless experience for your users.
                    </p>
                </div>
            </div>
            <div class="a4 ak md:a1T/2 lg:a1T/3 2xl:a1T/4">
                <div class="aU a1U a1V a1W a1G aM a1X a1w hover:a1z hover:aH">
                    ...
                    <p class="aW a1o a1t">
                        We prioritize the security and integrity of your digital assets. Mintify leverages the immutability and transparency of blockchain technology to provide verifiable proof of ownership and ensure the authenticity of every NFT minted.
                    </p>
                </div>
            </div>
        </div>
